# tests for fibheap
# this combines jeanette and cindy's fibheap tests thus far

from fibheap_yjp_20130423 import *

output = open("output_of_fibtests.txt", "w+")
# ****** tests for TreeNode functions ***********
print >> output, "Testing TreeNode.add_child"
...
print >> output, "\n ----Testing one-node heap pop ---"
fibheap1 = FibHeap()
fibheap1.insert(TreeNode(50,"url"))
fibheap1.print_heap(output)
